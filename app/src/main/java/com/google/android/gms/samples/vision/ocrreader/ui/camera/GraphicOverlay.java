...
import com.google.android.gms.samples.vision.ocrreader.ListaEnlazadaDoble;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public  ArrayList<T> getAllGraphicAtLocation() {
        synchronized (mLock) {
            // Get the position of this View so the raw location can be offset relative to the view.
            int[] location = new int[2];
            ArrayList<T> tmpGraph = new ArrayList<>();

            ListaEnlazadaDoble lista = new ListaEnlazadaDoble();
            lista.addSetToList((Set<OcrGraphic>) mGraphics);
            lista.orderByPosition();
            lista.sendDataToArrayList((ArrayList<OcrGraphic>) tmpGraph);
